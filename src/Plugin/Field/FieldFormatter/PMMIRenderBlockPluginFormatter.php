 ...
 * )
 */
class PMMIRenderBlockPluginFormatter extends EntityReferenceFormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new PMMIRenderBlockPluginFormatter.
   *
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $item) {
      ...
      if (!empty($item->_loaded) && $settings['target_type'] == 'block') {
        ...
        $block = $block_storage->load($item->entity->id());
